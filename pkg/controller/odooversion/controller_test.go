...
func TestReconcile(t *testing.T) {
	...
	instance := &clusterv1beta1.OdooVersion{ObjectMeta: metav1.ObjectMeta{Name: "foo", Namespace: "default"}}
	...
	// Create the OdooVersion object and expect the Reconcile and Deployment to be created
