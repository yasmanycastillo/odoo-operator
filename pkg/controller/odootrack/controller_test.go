...
func TestReconcile(t *testing.T) {
	...
	instance := &clusterv1beta1.OdooTrack{ObjectMeta: metav1.ObjectMeta{Name: "foo", Namespace: "default"}}
	...
	// Create the OdooTrack object and expect the Reconcile and Deployment to be created
